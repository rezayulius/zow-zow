        ...
        <div class="max-w-4xl mx-auto">
            ...
            @if($isRegistered)
                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                    <!-- Profile Header -->
                    <div class="bg-gradient-to-r from-forest-moss-green-500 to-forest-moss-green-600 p-8 text-white">
                        <div class="flex items-center space-x-6">
                            <div class="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-lg">
                                ...
                                @else
                                    <span class="text-forest-moss-green-600 font-bold text-4xl">{{ strtoupper(substr($petParent['full_name'], 0, 1)) }}</span>
                                @endif
                            </div>
                            <div class="flex-1">
                                <h2 class="text-3xl font-bold mb-1">{{ $petParent['full_name'] }}</h2>
                                <p class="text-forest-moss-green-100 flex items-center">
                                    <i data-lucide="mail" class="w-4 h-4 mr-2"></i>
                                    {{ $petParent['email'] }}
                                </p>
                                <p class="text-forest-moss-green-100 flex items-center mt-1">
                            ...
                            <div class="text-right">
                                <div class="bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2">
                                    <p class="text-xs text-forest-moss-green-100">Client ID</p>
                    ...
                    <div class="p-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                <h3 class="text-xl font-bold text-carob-900 mb-4 flex items-center">
                                    <i data-lucide="user" class="w-5 h-5 mr-2 text-forest-moss-green-600"></i>
                                    Informasi Pribadi
                                </h3>
                            ...
                            <div class="space-y-4">
                                <h3 class="text-xl font-bold text-carob-900 mb-4 flex items-center">
                                    <i data-lucide="map-pin" class="w-5 h-5 mr-2 text-forest-moss-green-600"></i>
                                    Informasi Alamat
                                </h3>
                        ...
                        @if($petParent['observations'])
                            <div class="mt-6">
                                <h3 class="text-xl font-bold text-carob-900 mb-4 flex items-center">
                                    <i data-lucide="file-text" class="w-5 h-5 mr-2 text-forest-moss-green-600"></i>
                                    Catatan
                                </h3>
                                <div class="bg-soft-linen-50 rounded-lg p-4">
                        ...
                        <!-- Account Info -->
                        <div class="mt-6 pt-6 border-t border-soft-linen-200">
                            <h3 class="text-xl font-bold text-carob-900 mb-4 flex items-center">
                                <i data-lucide="info" class="w-5 h-5 mr-2 text-forest-moss-green-600"></i>
                                Informasi Akun
                            </h3>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="bg-gradient-to-br from-forest-moss-green-50 to-forest-moss-green-100 rounded-lg p-4 text-center">
                                    <i data-lucide="calendar" class="w-8 h-8 mx-auto mb-2 text-forest-moss-green-600"></i>
                                ...
                                <div class="bg-gradient-to-br from-forest-moss-green-50 to-forest-moss-green-100 rounded-lg p-4 text-center">
                                    <i data-lucide="hash" class="w-8 h-8 mx-auto mb-2 text-forest-moss-green-600"></i>
                        ...
                        <div class="mt-6 pt-6 border-t border-soft-linen-200">
                            <h3 class="text-xl font-bold text-carob-900 mb-4 flex items-center">
                                <i data-lucide="paw-print" class="w-5 h-5 mr-2 text-forest-moss-green-600"></i>
                                Hewan Peliharaan
                            ...
                            @if(count($pets) > 0)
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    @foreach($pets as $pet)
                                        @php
                                            $colorSchemes = [
                                                ['from' => 'forest-moss-green', 'to' => 'forest-moss-green', 'icon' => 'dog'],
                                                ['from' => 'chai', 'to' => 'chai', 'icon' => 'cat'],
                                                ['from' => 'forest-moss-green', 'to' => 'forest-moss-green', 'icon' => 'rabbit'],
                                                ['from' => 'vanilla', 'to' => 'soft-linen', 'icon' => 'bird']
                                            ];
                            ...
                            @else
                                <div class="bg-soft-linen-50 rounded-xl p-8 text-center">
                                    <div class="w-16 h-16 bg-soft-linen-200 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            @else
                ...
                <div class="bg-white rounded-2xl shadow-xl p-12 text-center">
                    ...
                    <div class="bg-soft-linen-50 rounded-xl p-6 max-w-2xl mx-auto mb-6">
                        ...
                        <ul class="text-left space-y-2 text-carob-700">
                            <li class="flex items-start">
                                <i data-lucide="check-circle" class="w-5 h-5 mr-2 text-forest-moss-green-600 flex-shrink-0 mt-0.5"></i>
            ...
            <div class="text-center mt-8">
                <a href="/" class="inline-flex items-center text-carob-600 hover:text-forest-moss-green-600 transition-all duration-200 font-medium">
