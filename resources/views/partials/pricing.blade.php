...
<section id="harga" class="py-16 bg-gradient-to-br from-chai-25 to-matcha-25">
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-chai-100 relative">
                ...
                <div class="pt-8">
                    ...
                    <div class="mb-4">
                        <span class="text-3xl font-bold text-chai-600">Rp 150.000</span>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-matcha-100">
                <div class="pt-4">
                    ...
                    <div class="mb-4">
                        <span class="text-3xl font-bold text-matcha-600">Rp 300.000</span>
                        <div class="flex items-center text-carob-500 text-sm mt-1">
                            <i data-lucide="clock" class="w-4 h-4 mr-1"></i>
                            45 minutes
                        </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-yellow-200 relative">
                ...
                <div class="pt-8">
                    ...
                    <p class="text-carob-600 text-sm mb-4">Full grooming service with luxury treatment</p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-carob-100">
                <div class="pt-4">
                    <h3 class="text-xl font-bold text-carob-900 mb-2">Spa Package</h3>
                    <p class="text-carob-600 text-sm mb-4">Relaxing spa treatment for your beloved pet</p>
                    
                    <div class="mb-4">
                        <span class="text-3xl font-bold text-carob-600">Rp 400.000</span>
                        <div class="flex items-center text-carob-500 text-sm mt-1">
                            <i data-lucide="clock" class="w-4 h-4 mr-1"></i>
                            3 hours
                        </div>
                    ...
                    <ul class="space-y-2 mb-6">
                        ...
                        <li class="text-carob-600 text-sm font-medium">+2 more features...</li>
                    </ul>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <!-- Hotel Stay -->
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-chai-100">
                <h3 class="text-xl font-bold text-carob-900 mb-2">Hotel Stay (per night)</h3>
                <p class="text-carob-600 text-sm mb-4">Comfortable accommodation with 24/7 care</p>
                
                <div class="mb-4">
                    <span class="text-3xl font-bold text-chai-600">Rp 200.000</span>
                    <div class="flex items-center text-carob-500 text-sm mt-1">
                        <i data-lucide="clock" class="w-4 h-4 mr-1"></i>
                        24 hours
                    </div>
                ...
                <ul class="space-y-2 mb-6">
                    ...
                    <li class="text-chai-600 text-sm font-medium">+2 more features...</li>
                </ul>
            ...
            <!-- Day Care -->
            <div class="bg-white rounded-2xl p-6 shadow-lg border border-matcha-100">
                <h3 class="text-xl font-bold text-carob-900 mb-2">Day Care</h3>
                <p class="text-carob-600 text-sm mb-4">Daily care and supervision for working pet parents</p>
                
                <div class="mb-4">
                    <span class="text-3xl font-bold text-matcha-600">Rp 100.000</span>
                    <div class="flex items-center text-carob-500 text-sm mt-1">
                        <i data-lucide="clock" class="w-4 h-4 mr-1"></i>
                        8 hours
                    </div>
                ...
                <ul class="space-y-2 mb-6">
                    ...
                    <li class="text-matcha-600 text-sm font-medium">+2 more features...</li>
                </ul>
        ...
        <div class="bg-gradient-to-r from-yellow-100 to-yellow-200 rounded-3xl p-8 text-center">
            ...
            <button class="bg-carob-600 text-white px-8 py-3 rounded-xl hover:bg-carob-700 transition-colors font-semibold">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-carob-600 max-w-3xl mx-auto">
                Nikmati kemudahan teknologi terdepan dalam perawatan kesehatan hewan peliharaan yang dirancang khusus untuk kenyamanan Anda dan pet kesayangan
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg border border-carob-100">
                <div class="flex items-start mb-6">
                    <div class="bg-blue-100 rounded-2xl p-3 mr-4">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center mb-2">
                            ...
                            <span class="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full font-medium ml-3">NEW</span>
                        </div>
                        <p class="text-carob-600 mb-4">Sistem booking appointment canggih dengan konfirmasi langsung untuk pet Anda</p>
                        <ul class="space-y-2">
                            <li class="flex items-center text-sm text-carob-700">
                                <i data-lucide="check" class="w-4 h-4 text-green-500 mr-2"></i>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg border border-carob-100">
                <div class="flex items-start mb-6">
                    <div class="bg-green-100 rounded-2xl p-3 mr-4">
                        <i data-lucide="bot" class="w-8 h-8 text-green-600"></i>
                    </div>
                    <div class="flex-1">
                        <div class="flex items-center mb-2">
                            <h3 class="text-xl font-bold text-carob-900">ZOW AI Pet Assistant</h3>
                            <span class="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full font-medium ml-3">ENHANCED</span>
                        </div>
                        <p class="text-carob-600 mb-4">Asisten AI pintar yang siap menjawab pertanyaan seputar perawatan pet Anda 24/7</p>
                        <ul class="space-y-2">
                            <li class="flex items-center text-sm text-carob-700">
                                <i data-lucide="check" class="w-4 h-4 text-green-500 mr-2"></i>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg border border-carob-100">
                <div class="flex items-start mb-6">
                    <div class="bg-yellow-100 rounded-2xl p-3 mr-4">
                        <i data-lucide="credit-card" class="w-8 h-8 text-yellow-600"></i>
                    </div>
                    <div class="flex-1">
                        <div class="flex items-center mb-2">
                        ...
                        <p class="text-carob-600 mb-4">Berbagai metode pembayaran yang aman dan mudah untuk semua layanan pet care</p>
                        <ul class="space-y-2">
                            <li class="flex items-center text-sm text-carob-700">
                                <i data-lucide="check" class="w-4 h-4 text-green-500 mr-2"></i>
                                Kartu Kredit/Debit
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg border border-carob-100">
                <div class="flex items-start mb-6">
                    <div class="bg-purple-100 rounded-2xl p-3 mr-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-carob-600 mb-4">Sistem konfirmasi otomatis dengan notifikasi WhatsApp untuk setiap appointment pet</p>
                        <ul class="space-y-2">
                            <li class="flex items-center text-sm text-carob-700">
                                <i data-lucide="check" class="w-4 h-4 text-green-500 mr-2"></i>
        ...
        <div class="text-center">
            <div class="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-3xl p-8 text-center">
                <div class="flex items-center justify-center mb-4">
                    <i data-lucide="zap" class="w-8 h-8 text-yellow-800 mr-2"></i>
                </div>
                <h3 class="text-2xl md:text-3xl font-bold text-carob-900 mb-4">Siap Memberikan yang Terbaik untuk Pet Kesayangan?</h3>
                <p class="text-carob-700 mb-6 max-w-2xl mx-auto">
                    Bergabunglah dengan ribuan pet lovers yang mempercayakan kesehatan hewan kesayangan mereka pada teknologi canggih kami
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <button class="bg-carob-600 text-white px-8 py-3 rounded-xl hover:bg-carob-700 transition-colors font-semibold flex items-center justify-center">
                        <i data-lucide="calendar" class="w-5 h-5 mr-2"></i>
                        Booking Sekarang
                    </button>
                    <button class="bg-white text-carob-700 px-8 py-3 rounded-xl hover:bg-carob-50 transition-colors font-semibold flex items-center justify-center border border-carob-200">
