    ...
    public static function for(?string $slug): array
    {
        return match ($slug) {
            ...
            'wellness' => [
                ...
                'iconBg' => 'bg-chai-100',
                'iconText' => 'text-chai-700',
                'iconShadow' => 'shadow-chai-200/50',
                'heading' => 'text-chai-900',
                'headingHover' => 'text-chai-700',
                // chai-700/chai-600 read as ~3.5:1 and ~2.6:1 against white --
                // both fail WCAG AA's 4.5:1 text contrast minimum. Darkened
                // to chai-800 (5.4:1) for text and button backgrounds paired
                // with white text, which passes while staying visibly on-brand.
                'body' => 'text-chai-800',
                'badgeBg' => 'bg-chai-100',
                'badgeText' => 'text-chai-800',
                'linkText' => 'text-chai-800',
                ...
                'buttonBg' => 'bg-chai-800',
                'buttonBgHover' => 'hover:bg-chai-900',
